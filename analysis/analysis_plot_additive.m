...
function analysis_plot_additive(file_names,plot_opts)
...
% 2024-01-16 Pinene
%a_thisfile_spt1 = '2024-01-16_datafile_09'; % A1 Pinene
%a_thisfile_spt2 = '2024-01-16_datafile_10'; % A2 Pinene
%a_thisfile_add = '2024-01-16_datafile_14';  % A1 & A2 Pinene
...
a_this_note = 'A1 & A2 (Pinene)';

%dir_mat_file_spt1 = strcat(a_dir_OlfaControlGUI,'\analysis\data (.mat files)\',a_thisfile_spt1,'.mat');
%dir_mat_file_spt2 = strcat(a_dir_OlfaControlGUI,'\analysis\data (.mat files)\',a_thisfile_spt2,'.mat');
%dir_mat_file_add = strcat(a_dir_OlfaControlGUI,'\analysis\data (.mat files)\',a_thisfile_add,'.mat');
...
f1.Name = [a_thisfile_add,' - ',a_this_note];
