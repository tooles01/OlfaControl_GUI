...
4. **Gets PID baseline value**  
	- Get the minimum PID value recorded in the first trial - this will be out new "0"
...
5. **Adjusts data for each trial/calculate stuff**  
	...
	- For each trial:
		- Adjust PID
			...
			- Create array of time values (using *c.nidaq_freq*) so we can create array of [time, PID data] for this trial (`pid_data`)
			- Shift PID up to 0
		...
		- Add to the data structure (*d_olfa_data*)  
			<img src="images/d_olfa_data.png" width="40%">
