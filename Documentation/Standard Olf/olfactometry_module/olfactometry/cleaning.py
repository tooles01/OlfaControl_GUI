...
class Cleaner(QtWidgets.QWidget):
    def __init__(self, config=None):
        ...
        olfa_type_select = QtWidgets.QComboBox()
        ...
        self.valve_clean_time_selector = QtWidgets.QSpinBox()
        ...
        self.valve_clean_time_selector_lbl = QtWidgets.QLabel('Valve clean time:')
        ...
        self.dummy_flush_time_selector = QtWidgets.QSpinBox()
        ...
        self.dummy_flush_time_selector_lbl = QtWidgets.QLabel('Dummy flush time:')
        ...
        air_flush_button = QtWidgets.QRadioButton('Air Flush')
        ...
        progress_bar_lbl = QtWidgets.QLabel('Progress:')
    ...
    def _type_selected(self, typestr):
        if typestr == 'Select olfa type':
            ...
            self.arduino_serial_select = QtWidgets.QComboBox()
    ...
    def _arduino_com_selected(self, com_str):
        ...
        if com_str == 'Select COM port':
            ...
            self.olfactometer = TeensyOlfa(None, config_dict=teensy)
            self.main_layout.addWidget(self.olfactometer)
            vials = [int(v) for v in list(teensy['Vials'].keys())]
            vials.sort()
...
class ValveSelector(QtWidgets.QGroupBox):
    def __init__(self, parent, vials, default_off=[]):
        ...
        button_group.buttonClicked[QtWidgets.QAbstractButton].connect(self._button_clicked)
        self.vials_to_clean = []
        for i in vials:
            b = QtWidgets.QCheckBox(str(i))
            layout.addWidget(b)
